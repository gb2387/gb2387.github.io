var WeeklyDeath={
  display: async function () {
    ...
    d3.select("#WeeklyCase").selectAll("svg").remove();
    d3.select("#WeeklyDeath").selectAll("#stateDiv1").remove();
    d3.select("#WeeklyDeath").selectAll("svg").remove();
    ...
    d3.select("#WeeklyDeath").append("div").attr("id","stateDiv1").append("label").text("Select a State: ").attr("style","font-size:15px;font-weight:bold;");
